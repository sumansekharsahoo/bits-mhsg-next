    ...
    <div className='confessContainer px-[12px] py-[8px] my-[10px] rounded-xl border-[2px] border-[#b0b0b0] lg:w-[70%] sm:w-[80%] w-[95%] flex flex-col align-middle text-[#474747]' style={{display}}>
        ...
        <div className='flex justify-between'>
            ...
            <span>
                ...
                {edit?<a href={mailto}  target="_blank" className='border-[1px] border-[#b0b0b0] rounded-md px-[5px] py-[5px] md:text-[18px] text-[14px] bg-[#95dcbd]'>Resolve <GoArrowRight className='inline'/></a>:<button onClick={deleteConfess} className='text-[21px] delIcon sm:text-[24px]'><LuTrash /></button>}
            </span>
